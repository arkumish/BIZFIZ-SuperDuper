...
export default class Form extends React.Component {
  ...
  onNewRequest(chosenRequest, index) {
    console.log(chosenRequest.value)
    this.setState({
      businessState: chosenRequest.value
    })
  }
  ...
  validate = () => {
    ...
    if (this.state.mobileNumber.length < 10) {
      isError = true;
      errors.mobileNumberError = "Please enter a valid mobileNumber number";
    }

    if (this.state.typeOfBusiness.length < 1) {
      isError = true;
      errors.typeOfBusinessError = "Please enter type of your business";
    }

    if (this.state.businessDistrict.length < 1) {
      isError = true;
      errors.businessDistrictError = "Please enter your district";
    }

    if (this.state.businessPinCode.length < 1 && this.state.businessPinCode.length !== 6) {
      isError = true;
      errors.businessPinCodeError = "Please enter correct pincode";
    }

    if (this.state.amountApplied.length < 1) {
      isError = true;
      errors.amountAppliedError = "Please enter the amount in rupees";
    }

    if (this.state.businessState.length < 1) {
      isError = true;
  ...
  onSubmit = async e => {
    ...
    if (!err) {
      ...
      let responseData = {
        ...
        amountApplied: this.state.amountApplied,
        applicationStatus: 0
      }
      console.log(responseData)
      const response = await axios.post('https://bizfizbe.herokuapp.com/addborrower', responseData, {
      headers: {
        "Content-Type": "application/json"
      }
    });
    this.setState({
      url: response.data.consentUrl
    })
    console.log(response, response.data, "#####")
      ...
      window.location = response.data.consentUrl;
    }
  };
     ...
     <form>
        ...
        <SelectField
          ...
          onChange={(event, index, value) =>
            this.setState({ typeOfBusiness: value })
          }
          float="left"
          errorText={this.state.typeOfBusinessError}
          floatingLabelFixed
          style={this.inputStyles}
        >
        ...
        <TextField
          ...
          onChange={e => this.change(e)}
          errorText={this.state.businessAddressError}
          floatingLabelFixed
          style={this.inputStyles}
        />
        <br />
        <TextField
          ...
          onChange={e => this.change(e)}
          errorText={this.state.businessDistrictError}
          floatingLabelFixed
          style={this.inputStyles}
        />
        <br />
        <TextField
          ...
          onChange={e => this.change(e)}
          errorText={this.state.businessPinCodeError}
          floatingLabelFixed
          style={this.inputStyles}
        />
        <br />
        <AutoComplete
          ...
          onChange={e => this.change(e)}
          errorText={this.state.businessStateError}
          floatingLabelFixed
        ...
        <TextField
          ...
          onChange={e => this.change(e)}
          errorText={this.state.amountAppliedError}
          floatingLabelFixed
          style={this.inputStyles}
        />
        <br />
        <br />
        <RaisedButton label={this.state.applyButtonText} onClick={e => this.onSubmit(e)} primary />
        <br/>
        <br/>
        <br/>
      </form>
